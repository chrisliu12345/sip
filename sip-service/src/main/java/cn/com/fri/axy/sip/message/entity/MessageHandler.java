package cn.com.fri.axy.sip.message.entity;

import cn.com.fri.axy.comet.pushlet.MessageSender;
import cn.com.fri.axy.common.def.message.content.AlarmRequest;
import cn.com.fri.axy.common.def.message.content.DeviceStatusResponse;
import cn.com.fri.axy.common.def.message.content.KeepaliveRequest;
...
public class MessageHandler extends cn.com.fri.axy.sip.entity.Handler implements ResendInterface {
    ...
    public void sendMessage(Message paramMessage) {
        ...
        if (!RegExUtil.validateCode(localObject = paramMessage.getDestid())) {
            throw new IllegalArgumentException("destID:" + (String) localObject);
        }
        ...
        if (paramMessage.isOnlyReqMessage()) {
            ...
            this = this;
            try {
                localObject = AppMessageManager.getInstance().genSN();
                paramMessage.setSn((String) localObject);
                a(paramMessage);
            } catch (MessageException localMessageException1) {
                SysLogger.printStackTrace(localObject = localMessageException1);
                throw ((Throwable) localObject);
            } catch (Exception localException1) {
                SysLogger.printStackTrace(localObject = localException1);
                throw new MessageException((Throwable) localObject);
            }
            ...
            try {
                if (((ReqResMessage) paramMessage).isAppRequest()) {
                    localObject = AppMessageManager.getInstance().genSN();
                    paramMessage.setSn((String) localObject);
                    ((cn.com.fri.axy.sip.message.content.ReqMessage) paramMessage).setHandler(this);
                }
                a(paramMessage);
                AppMessageManager.getInstance().sendReqResMessage((ReqResMessage) paramMessage);
                return;
            } catch (MessageException localMessageException2) {
                SysLogger.printStackTrace(localObject = localMessageException2);
                throw ((Throwable) localObject);
            } catch (Exception localException2) {
                SysLogger.printStackTrace(localObject = localException2);
                throw new MessageException((Throwable) localObject);
            }
        }
    }
    ...
    private void a(Message paramMessage) {
        try {
            ...
            localObject1 = ServletContextHelper.getSipFactory().createAddress(
                    LocationService.getInstance().getDomainURI(str));
            Object localObject2 = LocationService.getInstance().getLocalDomainURI();
            ...
            (
                    localObject2 = (localObject1 = ServletContextHelper.getSipFactory().createRequest(localSipApplicationSession, "MESSAGE", (Address) localObject2, (Address) localObject1)).getSession(true)).setHandler("accessservlet");


            if (paramMessage.getClass().getName().indexOf("cn.com.fri.axy.business.common.jsonMessage") > -1) {
                ((SipServletRequest) localObject1).setCharacterEncoding("GB2312");
                ((SipServletRequest) localObject1).setContent(paramMessage.getXmlContent(), "text/html");

            } else {

                localObject2 = (localObject2 = paramMessage.getXmlContent().replaceFirst(" xmlns=\".*?\">", ">")).getBytes();


                ((SipServletRequest) localObject1).setContentLength(localObject2.length);
                ((SipServletRequest) localObject1).setContent(localObject2, "Application/MANSCDP+xml");
            }


            (localObject2 = new cn.com.fri.axy.sip.entity.HandlerList()).add(this);
            ((SipServletRequest) localObject1).getSession().setAttribute("handlerList", localObject2);


            ((SipServletRequest) localObject1).pushRoute(LocationService.getInstance().getFullURIByID(str));


            if ((localObject2 = paramMessage.getPurviewBean()) != null) {

                if ((paramMessage = ((PurviewBean) localObject2).getPurviewHeader()).length() > 0) {
                    ((SipServletRequest) localObject1).addHeader("Monitor-User-Identity",
                            ((PurviewBean) localObject2).getPurviewHeader());
                }
            }
            ...
            throw new MessageException((Throwable) localObject1);
        }
    }
    ...
    public void doMessage(MessageContext paramMessageContext) {
        ...
        try {
            ...
            try {
                if ("MediaStatus".equalsIgnoreCase(str)) {
                    ...
                    if ((localObject = InviteManager.getInstance().getInviteHandlerByCallID((String) localObject)) != null) {
                        InviteManager.getInstance().endInviteSession(((cn.com.fri.axy.sip.call.invite.InviteHandler) localObject).getLinkageID());
                    }
                }
            } catch (Exception localException3) {
                SysLogger.printStackTrace(localObject = localException3);
            }
            ...
            if (((Message) localObject).isReqResMessage()) {
                this = (MessageHandler) localObject;
    ...
    public static void main(String[] paramArrayOfString) {
        paramArrayOfString = (paramArrayOfString = "<?xml version=\"1.0\" encoding=\"gb2312\" standalone=\"yes\" ?><Request xmlns=\"www.axy.fri.com.cn/sip/sipsessionservice/message/xmlparser/alarm\"><Notify><CmdType>Alarm</CmdType><DeviceID>alarmer01</DeviceID><AlarmPriority>high</AlarmPriority><AlarmMethod>110</AlarmMethod><AlarmTime>2007-07-01T09:30:10.5</AlarmTime><Longtitude>116</Longtitude><Latitude>47</Latitude><Info>no infomation!</Info></Notify></Request>").replaceFirst(" xmlns=\".*?\">", ">");
