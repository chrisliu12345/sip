...
public class LookupTag extends TagSupport {
    public int doEndTag() {
        ...
        try {
            ...
            Object localObject1;
            String str;
            for (localObject2 = RegistrationService.getInstance().getAllRegistrations().values().iterator(); ((Iterator) localObject2).hasNext(); ) {
            ...
            try {
                ...
                Object localObject2;
                SysLogger.printStackTrace(localObject2 = localIOException);
            }
