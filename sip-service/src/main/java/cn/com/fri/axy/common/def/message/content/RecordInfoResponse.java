...
public class RecordInfoResponse
    ...
    public RecordInfoResponse(String paramString) {
        super(paramString, "RecordInfo");
    }
    ...
    public static void main(String[] paramArrayOfString) {
        ...
        (localDeviceCatalogResponse = new DeviceCatalogResponse(null)).setXmlContent(paramArrayOfString);
...
/* Location:home/wuqf/Desktop/sip.jar!/cn/com/fri/axy/common/def/message/content/RecordInfoResponse.class
