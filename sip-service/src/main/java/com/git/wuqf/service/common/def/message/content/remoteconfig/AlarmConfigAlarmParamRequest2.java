...
public class AlarmConfigAlarmParamRequest2
        extends ReqMessage {
    private String a;
    private Long b;
    private String c;
    ...
    public AlarmConfigAlarmParamRequest2(String paramString, Observer paramObserver) {
    ...
    public void genXmlContent() {
        ...
        localStringBuffer.append("<AlarmParam>\n");
        if (this.b != null) {
            int i;
        ...
        SysLogger.info("报警器值守时间信息：" + localStringBuffer.toString());
    }
...
/* Location:home/wuqf/Desktop/sip.jar!/cn/com/fri/axy/common/def/message/content/remoteconfig/AlarmConfigAlarmParamRequest2.class
