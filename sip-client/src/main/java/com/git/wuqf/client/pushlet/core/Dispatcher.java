...
public class Dispatcher
    ...
    static {
        try {
            instance = (Dispatcher) Config.getClass("dispatcher.class", "nl.justobjects.com.git.wuqf.pushlet.core.Dispatcher").newInstance();
    ...
    public synchronized void broadcast(Event anEvent) {
        try {
            ...
            args[1] = anEvent;
            Method method = this.sessionManagerVisitor.getMethod("visitBroadcast");
            SessionManager.getInstance().apply(this.sessionManagerVisitor, method, args);
        } catch (Throwable t) {
    ...
    private class SessionManagerVisitor {
        ...
        SessionManagerVisitor()
            ...
            try {
                ...
                this.visitorMethods.put("visitMulticast", getClass().getMethod("visitMulticast", argsClasses));
                this.visitorMethods.put("visitBroadcast", getClass().getMethod("visitBroadcast", argsClasses));
