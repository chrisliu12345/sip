...
import com.git.wuqf.client.pushlet.core.EventParser;
...
public class PushletClient
    ...
    public PushletClient(String aHost, int aPort) {
        this("http://" + aHost + ":" + aPort + "/com/git/wuqf/client/pushlet/com.git.wuqf.pushlet.srv");
    }
    ...
    public void listen(PushletClientListener aListener, String aMode, String aSubject)
        ...
        String listenURL = this.pushletURL + "?" + "p_event" + "=" + "listen" + "&" + "p_id" + "=" + this.id + "&" + "p_mode" + "=" + aMode;
        if (aSubject != null) {
    ...
    public void joinListen(PushletClientListener aListener, String aMode, String aSubject)
        ...
        String listenURL = this.pushletURL + "?" + "p_event" + "=" + "join-listen" + "&" + "p_format" + "=" + "xml" + "&" + "p_mode" + "=" + aMode + "&" + "p_subject" + "=" + aSubject;
    ...
    protected void throwOnNack(Event anEvent)
            throws PushletException {
    ...
    protected void throwOnInvalidSession()
            throws PushletException {
        if (this.id == null) {
            throw new PushletException("Invalid com.git.wuqf.pushlet session");
        }
    }

    protected Reader openURL(String aURL)
            throws PushletException {
        try {
    ...
    protected class DataEventListener
                    ...
                    while ((this.receiveThread != null) && (this.receiveThread.isAlive())) {
                        ...
                        if ((event != null) && (this.listener != null)) {
                            ...
                            if (eventType.equals("hb")) {
                                ...
                                PushletClient.this.p("Listen ack ok");
                            } else if (!eventType.equals("refresh-ack")) {
        ...
        protected void refresh(Event aRefreshEvent)
            ...
            this.refreshURL = (PushletClient.this.pushletURL + "?" + "p_id" + "=" + PushletClient.this.id + "&" + "p_event" + "=" + "refresh");
            if (this.reader != null) {
                try {
                    this.reader.close();
