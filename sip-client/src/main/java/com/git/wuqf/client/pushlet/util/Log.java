...
import com.git.wuqf.client.pushlet.core.Config;
import com.git.wuqf.client.pushlet.core.ConfigDefs;
...
public class Log
    ...
    public static void init() {
        try {
            logger = (PushletLogger) Config.getClass("logger.class", "nl.justobjects.com.git.wuqf.pushlet.util.DefaultLogger").newInstance();
        } catch (Throwable t) {
