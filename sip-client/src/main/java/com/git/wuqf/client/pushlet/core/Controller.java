...
public class Controller
    ...
    public static Controller create(Session aSession)
        ...
        try {
            controller = (Controller) Config.getClass("controller.class", "nl.justobjects.com.git.wuqf.pushlet.core.Controller").newInstance();
        } catch (Throwable t) {
    ...
    protected void doListen(Command aCommand)
        ...
        info("Listening mode=" + mode + " userAgent=" + this.session.getUserAgent());
    }
